...
public class AppLancherState : ViewModelBase
{
    public ObservableCollection<AppLancherAppItem> Apps { get; private set; } = [];
    public AppLancherAppItem? SelectedApp { get; set; }
    public AppLancherState()
    {
        // 起動時復元
    ...
    {
        Apps.Add(AppLancherAppItem.FromPath(file));
    }
