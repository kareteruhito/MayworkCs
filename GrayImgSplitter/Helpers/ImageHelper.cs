...
public static partial class ImageHelper
{
    ...
    public static BitmapSource LoadWithColorProfile(string path)
    {
        ...
        // PNG側のColorContext
        var srcContext = frame.ColorContexts?.FirstOrDefault();
        ...
        var dstContext = new ColorContext(
            new Uri("file:///C:/Windows/System32/spool/drivers/color/sRGB Color Space Profile.icm"));
